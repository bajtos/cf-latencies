...
async function fetchCached(path, request, env, ctx) {
  ...
  const res = await fetch(url, {
    cf: {
      ...
      // Cache everything, including HTML responses
    }
  });
  if (!res.ok) {
...
// .wrangler/tmp/bundle-Jsnb7h/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-Jsnb7h/middleware-loader.entry.ts
